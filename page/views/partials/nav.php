<nav class="bg-gray-800">
    ...
    <a href="/about" class="<?= $_SERVER['REQUEST_URI'] === '/about' ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> rounded-md  px-3 py-2 text-sm font-medium text-white " aria-current="page">About</a>
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="/about.php" class="block rounded-md  px-3 py-2 text-base font-medium bg-gray-900 text-white hover:bg-gray-700 hover:text-white">About</a>
